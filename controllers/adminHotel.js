...
const getAdmin = async (req = request, res = response) => {
    try {
        ...
        res.status(404).send({
            msg: "No se pudo listar el ADMIN_HOTEL",
            err,
          });
    }
}

const getAdminAll = async (req = request, res = response) => {

    try {
        const query = {rol: "ADMIN_HOTEL"};
        const listaUsuarios = await Usuario.find(query);
        ...
        res.status(404).send({
            msg: "No se pudo listar los ADMIN_HOTEL",
            err,
          });
    }
}
...
const postAdmin = async (req = request, res = response) => {
    try {
        ...
        res.status(404).send({
            msg: "No se pudo guardar el ADMIN_HOTEL",
            err,
          });
    }
...
const putAdmin = async (req = request, res = response) => {
    try {
        ...
        res.status(404).send({
            msg: "No se pudo editar el ADMIN_HOTEL",
            err,
          });
    }
}
...
const deleteAdmin = async(req = request, res = response) => {
    try {
        ...
        res.status(404).send({
            msg: "No se pudo eliminar el ADMIN_HOTEL",
            err,
          });
    }
}
